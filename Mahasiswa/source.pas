...
var
   ...
   procedure TambahDataBaru (var DMhs:DataMhs);
   var
      i : integer;
      tambah : integer;
   ...
   begin
        clrscr();
        Kotak(28,12,52,14,CYAN,WHITE);
        gotoxy(30,13); write('Jumlah Data Baru : '); readln(tambah);
...
begin
     ...
     repeat
           ...
           gotoxy(26,20); writeln('8. Tambah Data');
